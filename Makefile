...
.PHONY: help ci init venv install install-python install-frontend clean-venv clean-frontend clean-logs \
...
ci: install lint build test test-python-backend test-python-e2e test-frontend-e2e compose-down
